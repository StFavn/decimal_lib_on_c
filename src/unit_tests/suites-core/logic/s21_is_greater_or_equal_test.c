...
START_TEST(normal_is_greater) {
  ...
  ck_assert(s21_is_greater_or_equal(dec_1, dec_2));
}
END_TEST
...
START_TEST(normal_is_not_greater) {
  ...
  ck_assert(s21_is_greater_or_equal(dec_1, dec_2) == 0);
}
END_TEST
...
START_TEST(edge_scale_overflow_test) {
  ...
  ck_assert(s21_is_greater_or_equal(dec_1, dec_2) == 1);
}
END_TEST
...
Suite *suite_s21_is_greater_or_equal() {
  Suite *suite = suite_create("suite_s21_is_greater_or_equal");
